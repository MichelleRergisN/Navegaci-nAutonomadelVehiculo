...
class PathGeneratorClass(Node):
	def __init__(self):
		...
		# self.point_list = [[1.0, 1.0, 10.0],
		#                     [10.0, 10.0, 20.0],
		#                     [1.0, 1.0, 30.0]] #Point to visit
		self.point_list = [
			[0.8, 0.0, 5.0],   # Esquina inferior izquierda
			[0.8, 0.8, 10.0],  # Inferior derecha
			[0.0, 0.8, 15.0],  # Superior derecha
			[0.0, 0.0, 20.0],  # Superior izquierda  # Regresar al inicio (cerrar cuadrado)
		]
		self.t0 = time.time()
